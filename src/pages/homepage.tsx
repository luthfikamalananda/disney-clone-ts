    ...
    return (
        <>
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-24 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto overflow-x-hidden bg-[#101414] dark:bg-gray-800 flex flex-col justify-evenly">
            ...
            <div className="content-wrapper ml-24 p-4 bg-[#101414] overflow-hidden">
